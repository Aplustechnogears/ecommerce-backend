...
app.post('/getMultipartPreSignedUrls', ProductController.getMultipartPreSignedUrls)
app.post('/finalizeMultipartUpload', ProductController.finalizeMultipartUpload)
